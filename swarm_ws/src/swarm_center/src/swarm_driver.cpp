...
//
//#define THRUST_BASE  		(40000)	/*»ù´¡ÓÍÃÅÖµ*/
//#define PIDVX_pid_output_LIMIT	120.0f	//ROLLÏÞ·ù	(µ¥Î»¡ã)
//#define PIDVY_pid_output_LIMIT	120.0f 	//PITCHÏÞ·ù	(µ¥Î»¡ã)
//#define PIDVZ_pid_output_LIMIT	(20000)	/*PID VZÏÞ·ù*/
//
//#define Int_max					20.0f
////#define Int_max					500.0f
//
//#define PIDX_pid_output_LIMIT	1200.0f	//XÖáËÙ¶ÈÏÞ·ù(µ¥Î»m/s)
//#define PIDY_pid_output_LIMIT	1200.0f	//YÖáËÙ¶ÈÏÞ·ù(µ¥Î»m/s)
//#define PIDZ_pid_output_LIMIT	120.0f	//ZÖáËÙ¶ÈÏÞ·ù(µ¥Î»m/s)
//
//using namespace std;
//
//class csvdata{
...
//    std::vector<csvdata> cmd_incsv;
//#endif
//
//    // MiniflyRos(const std::string &dev_name, const std::string &parampath, int baudrate);
//    MiniflyRos(const std::string &parampath, uint8_t id_input);
//    ~MiniflyRos();
//
//#ifdef USING_OFFLINE_TRAJECTORY
...
//MiniflyRos::MiniflyRos(const std::string &parampath, uint8_t id_input):
//        id(id_input)
//{
//    prefix = "MF" + std::to_string(id);
...
//
//
//	std::string paraadr("/home/sanmu/Minifly/Minifly_ros_ws/src/mini_swarm/data/"+parampath);
//	Parameter param;
...
//    ~MiniSwarm();
//    void addMf(const std::string &parampath, uint8_t id);
...
//    }
//}
//void MiniSwarm::addMf(const std::string &parampath, uint8_t id)
//{
//    MiniflyRos* mf = new MiniflyRos(parampath,id);
